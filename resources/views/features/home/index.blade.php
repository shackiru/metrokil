        ...
        <div class="col-span-3 lg:col-span-3 xl:col-span-2">
            <div class="hero">
                <div class="hero-content">
                    ...
                    <p class="text-md xl:text-lg mt-6 lg:mt-10 opacity-55 font-medium">PT Metrokil, perusahaan
                        pest
                        control yang
                        telah
                        menjadi
    ...
    <div class="mt-12 lg:mt-28 grid grid-cols-3 gap-10 lg:mx-14 xl:mx-44 mx-8">
        ...
        <div class="col-span-3 lg:col-span-2">
            <div class="about-content flex flex-col justify-between h-full">
                ...
                <p class="lg:text-lg opacity-70 mt-6 lg:mt-0">Kami adalah <span class="text-primary">perusahaan pembasmi
                        hama</span>
                    yang
                    berbasis di Jakarta,
