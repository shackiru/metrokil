            ...
            <div class="hero">
                <div class="hero-content">
                    ...
                    <div class="flex gap-6 mt-10">
                        <a href="https://api.whatsapp.com/send/?phone=6281998405395&text=Halo!,+Saya+tertarik+untuk+menyewa+jasa+Metrokil!&type=phone_number&app_absent=0"><button class="hover:shadow-regular transition button bg-primary text-white px-6 py-4 h-full rounded-lg font-semibold">Hubungi
                            Kami</button></a>
                            <a href="/services#pricing"><button
                            class="hover:shadow-regular transition button border-primary border-2 inner text-primary px-6 py-4 h-full rounded-lg font-semibold hover:bg-primary hover:text-white">Daftar
                            Harga</button></a>
                    </div>
                </div>
            </div>
    ...
    <div class="mt-28 grid grid-cols-3 gap-10 mx-44">
        ...
        <div class="col-span-2">
            <div class="about-content flex flex-col justify-between h-full">
                ...
                <a href="/about" class="group about-history cursor-pointer">
    ...
    <div class="mt-28 mx-44">
        <div class="service-header flex justify-between items-center">
            ...
            <a href="/services">
                ...
                <p class="font-medium text-lg text-primary hover:underline transition">Pelajari selengkapnya
                </p>
                ...
                <div class="service-description p-4 flex flex-col justify-between">
                    ...
                    <div class="w-100 flex justify-end">
                        <a href="/contact"><button
                            class="flex ring-primary ring-[1.5px] text-primary items-center px-3 py-1 font-semibold rounded-lg group hover:bg-primary hover:text-white transition">Pesan
                            layanan
                            <svg class="text-primary group-hover:text-white transition" xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            <div class="px-44 flex justify-between items-center">
                ...
                <a href="/testimonials">
                    <div class="flex gap-3 text-white">
                        <p class="font-medium text-lg hover:underline transition">Pelajari selengkapnya
                        </p>
        ...
        <div class="w-full left-0">
            <div class="px-44 flex justify-between items-center">
                ...
                <div class="flex gap-3">
                    <p class="font-medium text-lg text-primary hover:underline transition">Pelajari selengkapnya</p>
                    <img src="{{ asset('icons/Iconsax/Svg/All/linear/arrow-right-red.svg') }}" alt=""
                        width="20">
                </div>
                </a>
            </div>
            <div class="blogs px-44 flex mt-4 gap-4 overflow-visible w-full overflow-x-auto py-4">
            @foreach ($blogs as $blog)
                <a href="/blogs/{{ $blog->id }}">
                    <x-blog-card date="{{ $blog->created_at }}" category="{{ $blog->category }}" image="{{ $blog->image_url }}"
                        author="{{ $blog->user->name }}" isLimitWidth="true">
