            ...
            <div class="about-description flex justify-between shadow-soft rounded-xl">
                <div class="about-content p-12 flex flex-col text-center">
                    <div>
                        ...
                        <p class="text-lg mt-2 just">kami hadir di beberapa daerah mulai dari Jakarta, Malang, dan
                            Bandung</p>
                    </div>
                </div>
            </div>
            ...
            <div class="about-description flex justify-between shadow-soft rounded-xl">
                <div class="about-content p-12 flex flex-row">
                    <div class="grid md:grid-cols-5">
                        <div class="vision-icon md:col-span-1 md:flex md:justify-center md:items-center text-center">
                        </div>
                        <div class="vision-content flex flex-col col-span-4 justify-center">
                            <h1 class="text-2xl font-semibold">Visi Kami</h1>
                            <p class="text-lg font-medium mt-2">Metrokil adalah salah satu merek terkenal di Indonesia
        ...
        <div class="about-detail grid grid-rows-3 gap-6 mt-6 mb-20 lg:mb-36">
            <div class="about-description flex justify-between shadow-soft rounded-xl">
                <div class="about-content p-8 flex flex-row">
                    <div class="grid md:grid-cols-5">
                        <div
                            class="vision-icon md:col-span-1 md:flex md:justify-center md:items-center text-center mb-4">
                            <h1>ini gambar</h1>
                        </div>
                        <div class="vision-content flex flex-col col-span-4 justify-center">
                ...
                <div class="about-content p-8 flex flex-row">
                    <div class="grid md:grid-cols-5">
                        ...
                        <div class="vision-content flex flex-col col-span-4">
                            ...
                            <p class="text-lg font-medium mt-2"><span class="text-primary">Metrokil</span> adalah salah
